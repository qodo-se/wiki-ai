...
async function renderSettings() {
    ...
    body.innerHTML = `
        ...
        <div>
            ...
            <p class="${CLS.fieldHelp} mb-3">Creates a point-in-time snapshot of the notes database, safe to take while the app is running. Download it and store it somewhere else — creating a new backup here overwrites the previous one, it isn't a history.</p>
            <div class="flex items-center gap-3">
                <button id="backup-btn" class="${CLS.primaryBtn}">Create backup</button>
                <a href="/api/v1/backup" download class="${CLS.pageBtn}">Download backup</a>
            </div>
